...
const audio = new Audio('https://file.io/VjS70ABvXaSR'); // Ganti 'nama_file_lagu.mp3' dengan URL file lagu yang ingin Anda gunakan
...
Iya.addEventListener("click", function () {
    ...
    if (Iya.value == 1) {
        ...
        Text.innerHTML = "Assalamualaikum, Hai ini saya.";
        ...
        Text.classList.remove('text-animate');
        void Text.offsetWidth; 
        Text.innerHTML = "Di hari raya ini mohon maaf lahir dan batin";
        Text.classList.add('text-animate');
    } else if (Iya.value == 7) {
